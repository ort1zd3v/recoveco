...
class ReportByDayDetailDataTable extends BlankDataTable
{
	...
	{
		$query = $model::whereBetween('selling_rows.created_at', [$this->startDate, $this->endDate])
		->selectRaw('
	...
	public function dataTable($query)
	{
		...
		$datatable->filter(function($query) {
			...
			$query->whereBetween('selling_rows.created_at', [$this->startDate, $this->endDate]);
