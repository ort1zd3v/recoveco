...
class InventoryMultiMovementDataTable extends BlankDataTable
{
	...
	protected function getColumns()
	{
		...
		$columns = [
			...
			['data' => 'barcode','visible' => false,  'title' => __('products.barcode'), 'name' => 'products.name'],
			...
			['data' => 'is_discountable','visible' => false, 'title' => "Descontable", 'name' => 'products.is_discountable'],
			['data' => 'is_active', 'visible' => false, 'title' => __('inventory_movements.is_active')],
			['data' => 'notes', 'visible' => false, 'title' => __('inventory_movements.notes')],
