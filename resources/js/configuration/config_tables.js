$(function() {
	...
	$("#datatableHeaderBackgroundColor").change(function(){
		...
		const colorOpacity = convertToRGB(background_color);
		$("#datatableBodyPreview tr.odd").css('background-color', `rgba(${colorOpacity[0]}, ${colorOpacity[1]}, ${colorOpacity[2]}, 0.2)`);
		luminisity = 0.2126 * (colorOpacity[0] / 0.5) + 0.7152 * (colorOpacity[1] / 0.5) + 0.0722 * (colorOpacity[2] / 0.5);
		$("#datatableBodyPreview tr").hover(function(){
			if (luminisity < 128) {
				$(this).css('background-color', `rgba(${colorOpacity[0]}, ${colorOpacity[1]}, ${colorOpacity[2]}, 0.5)`);
			...
			if ($(this).hasClass('odd')) {
				$(this).css('background-color', `rgba(${colorOpacity[0]}, ${colorOpacity[1]}, ${colorOpacity[2]}, 0.2)`,);
				$(this).css('color', `#000000`);
