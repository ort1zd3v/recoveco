...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('client_attributes', function (Blueprint $table) {
            $table->increments('id')->comment('Identificador de la tabla de client_attributes');

            //
            $table->string('name')->comment('Nombre del attribute');
            $table->string('description')->nullable()->comment('Descripción del attribute');
            $table->boolean('is_required')->default(1)->comment('Muestra si es requerido');
