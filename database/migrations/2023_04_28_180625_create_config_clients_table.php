...
return new class extends Migration
{
	...
	public function up()
	{
		Schema::create('config_clients', function (Blueprint $table) {
			$table->increments('id');
			$table->float('refund_percentage', 10, 2)->comment('Porcentaje del total que se abonará como puntos al cliente');
			$table->float('min_required', 10, 2)->comment('Cantidad mínima de puntos que se necesitan para usarlos en un pago');
