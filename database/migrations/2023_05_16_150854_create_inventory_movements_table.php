...
return new class extends Migration
{
	...
	public function up()
	{
		Schema::create('inventory_movements', function (Blueprint $table) {
			...
			$table->integer('inventory_movement_type_id')->unsigned()->comment('Tipo de movimiento');
			$table->foreign('inventory_movement_type_id')->references('id')->on('inventory_movement_types');
			$table->integer('amount')->comment('Cantidad de productos');
