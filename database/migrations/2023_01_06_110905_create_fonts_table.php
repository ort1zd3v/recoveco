...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('fonts', function (Blueprint $table) {
			$table->increments('id')->comment('Identificador de la tabla de fonts');

            //
            $table->string('name')->comment('Nombre del font');
            $table->string('description')->nullable()->comment('Descripción del font');
